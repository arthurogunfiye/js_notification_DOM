...
const pushNotification = (posTop, posRight, title, description, type)=>{
    ...
    if (type === "success") notificationCard.classList.add("success");
    else if (type === "error") notificationCard.classList.add("error");
    else if (type === "warning") notificationCard.classList.add("warning");
    setTimeout(()=>{
